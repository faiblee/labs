package ru.ssau.tk.faible.labs.ui; // или ваш пакет
...
import ru.ssau.tk.faible.labs.ui.MainView; // замените на вашу основную страницу, если нужен переход
...
public class FunctionChoiceView extends VerticalLayout {
    ...
    public FunctionChoiceView() {
        ...
        Button myFunctionsButton = new Button("Мои функции", e -> {
            ...
            UI.getCurrent().navigate(MainView.class); // временно на главную
        });
