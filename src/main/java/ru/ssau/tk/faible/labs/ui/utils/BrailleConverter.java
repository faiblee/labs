...
public class BrailleConverter {
    ...
    static {
        ...
        BRAILLE_MAP.put('Г', "⠛"); BRAILLE_MAP.put('Д', "⠙"); BRAILLE_MAP.put('Е', "⠑"); BRAILLE_MAP.put('Ё', "⠑"); // 'Ё' → как 'Е'
        BRAILLE_MAP.put('Ж', "⠚"); BRAILLE_MAP.put('З', "⠵"); BRAILLE_MAP.put('И', "⠊"); BRAILLE_MAP.put('Й', "⠊"); // 'Й' → как 'И'
        ...
        BRAILLE_MAP.put('Ц', "⠉"); BRAILLE_MAP.put('Ч', "⠟"); BRAILLE_MAP.put('Ш', "⠱"); BRAILLE_MAP.put('Щ', "⠱"); // 'Щ' → как 'Ш'
    ...
    /**
     * Преобразует строку в "псевдографику Брайля".
     * Нераспознанные символы остаются без изменений.
     */
